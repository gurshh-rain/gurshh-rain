...
<p align="center">
Mechatronics Engineering student at the <b>University of Waterloo</b> (Tron '31). Building with passion in robotics, computer vision, AI/ML, LLM's, and the future of technology.<br/>
...
- **ROS2 Fleet Robot Manager** - Automate multi robot workflows in a warehouse with an automated task queue sending to the nearest robot. *(still in progress)*
- **ROS2 Robotic Arm (YOLOv8) control** - Trained robotic arm in gazebo to detect objects using YOLOv8 and picks them up.
### Controls & Systems
...
**Robotics** &nbsp;`ROS2` `PID Control` `Kinematics` `Servo/Motor Control` `Gazebo` `Nav2` `Fusion 360` `SOLIDWORKS` `Blender` `ANSYS`
