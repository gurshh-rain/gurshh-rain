...
- **ROS2 Robotic Arm (YOLOv8) control** - Trained robotic arm in gazebo to detect objects using YOLOv8 and picks them up. *(still in progress)*
### Controls & Systems
...
**Robotics** &nbsp;`ROS2` `PID Control` `Isaac Sim` `Servo/Motor Control` `Gazebo` `Nav2` `MoveIt2` `SLAM` `Fusion 360` `SOLIDWORKS` `Blender` `ANSYS`
